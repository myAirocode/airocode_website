...
@section('title', 'Airocode - Best Full Stack & Tech Training Institute in Pune, Pimpri-Chinchwad.')
@section('meta_description', 'Learn Full Stack Development at Airocode, Pimpri-Chinchwad, Pune. Expert faculty, hands-on projects & 85% placement support. Enroll in MERN, Java, Python & AI/ML.')
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="row gy-2 gx-4 mb-4">
                        ...
                        <div class="col-sm-12">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Join our weekday or weekend batches as per your convenience.</p>
                        </div>
                        <div class="col-sm-12">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Guaranteed placement assistance provided.</p>
                        </div>
                        <div class="col-sm-12">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Expert Mentors with Industry Experience</p>
                        </div>
                        <div class="col-sm-12">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Modern Infrastructure and Facilities.</p>
                        </div>
                        <div class="col-sm-12">
            ...
            <div class="row gy-2 gx-4 mb-4 text-white">
              ...
              <div class="col-12">
                <p class="mb-0">
                  ...
                  Advanced concepts with 4 major live projects
                </p>
              </div>
              <div class="col-12">
                <p class="mb-0">
                  ...
                  Full workflow with 6 projects plus placement guidance
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel position-relative">
            ...
            <div class="testimonial-item text-center">
                ...
                <p>Sr. UI Developer</p>
                <div class="testimonial-text bg-light p-4" style="text-align: justify;">
                    <p class="mb-0">
                        Airocode Technologies IT industrial training gave me hands-on exposure across all platforms. The guidance and real-world project experience boosted my skills and confidence. Highly recommended for anyone serious about IT excellence.
                    </p>
                </div>
            </div>
            ...
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text bg-light p-4" style="text-align: justify;">
                    <p class="mb-0">
                        Airocode Technologies provided excellent IT training that helped me grow as a full-stack developer. Their structured modules and practical approach enhanced my technical depth and problem-solving ability. A great experience overall!
                    </p>
                </div>
            </div>
            ...
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text bg-light p-4" style="text-align: justify;">
                    <p class="mb-0">
                        The training at Airocode Technologies was outstanding. I gained strong development skills and industry insights that truly shaped my career. Their expert trainers make complex topics easy to understand and apply in real projects.
                    </p>
                </div>
            </div>
            ...
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text bg-light p-4" style="text-align: justify;">
                    <p class="mb-0">
                        My experience with Airocode Technologies was fantastic. Their IT industrial training and web application development guidance helped me build real-world products confidently. It’s the best platform for learning and growth.
                    </p>
                </div>
            </div>
            ...
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text bg-light p-4" style="text-align: justify;">
                    <p class="mb-0">
                        Airocode Technologies training is exceptional. The mentors, practical projects, and all-platform exposure improved my development and design skills immensely. I recommend them to everyone aiming to excel in the IT industry.
                    </p>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-4">
                            ...
                            <p class="mb-0">contact@airocode.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-4">
                            ...
                            <p class="mb-0">Bavdhan / Pimpri-Chinchwad, Pune. India.</p>
                        </div>
                    </div>
                </div>
            </div>
